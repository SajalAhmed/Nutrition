...
class UpazillaTableSeeder extends Seeder
{
    ...
    {
        $upazilas=array(
            array('district_id' => '8','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'https://www.ccc.org.bd/'),
            array('district_id' => '15','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'https://erajshahi.portal.gov.bd/'),
            array('district_id' => '27','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'http://www.khulnacity.org/'),
            array('district_id' => '33','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'https://www.ccc.org.bd/'),
            array('district_id' => '36','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'https://scc.gov.bd/'),
            array('district_id' => '47','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'http://www.dncc.gov.bd/'),
            array('district_id' => '59','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'http://www.rpcc.gov.bd/'),
            array('district_id' => '62','name' => 'City Corporation','bn_name' => 'সিটি কর্পোরেশন','url' => 'http://www.mcc.gov.bd/'),
        );
        // $upazilas = array(
