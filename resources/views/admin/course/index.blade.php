                                    ...
                                    <div class="card-body">
                                        <form action="{{route("admin.course")}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="name_bn">Course Name</label><small class="req"> *</small>
                                                        <input type="text" name="name_bn" placeholder="Course Name" class="form-control {{ $errors->has('name_bn') ? ' is-invalid' : '' }}" required id="name_bn" >
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="purpose_bn">Course Purpose</label><small class="req"> *</small>
                                                        <textarea required name="purpose_bn" id="purpose_bn" class="form-control {{ $errors->has('purpose_bn') ? ' is-invalid' : '' }}" placeholder="Course Purpose" cols="30" rows="10"></textarea>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="method_bn">Course Method</label><small class="req"> *</small>
                                                        <textarea required name="method_bn" id="method_bn" class="form-control {{ $errors->has('method_bn') ? ' is-invalid' : '' }}" placeholder="Course Method" cols="30" rows="10"></textarea>
                                    ...
                                    {!! Form::open(['route' =>['admin.courseUpdate', 'course_id'=>$single->id],'files' => true]) !!}
                                     ...
                                     <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="name_bn">Course Name</label><small class="req"> *</small>
                                                <input type="text" name="name_bn" value="{{$single->name_bn}}" placeholder="Course Name" class="form-control {{ $errors->has('name_bn') ? ' is-invalid' : '' }}" required id="name_bn" >
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="course_zip_file_name">Off. Course File</label><code>(ZIP AND MAX SIZE 50MB)</code>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="purpose_bn">Course Purpose</label><small class="req"> *</small>
                                                <textarea required name="purpose_bn"  id="purpose_bn" class="form-control {{ $errors->has('purpose_bn') ? ' is-invalid' : '' }}" placeholder="Course Purpose" cols="30" rows="10">{{$single->purpose_bn}}</textarea>
                                                @if ($errors->has('purpose_bn'))
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('purpose_bn') }}</strong>
                                                </span>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="method_bn">Course Method</label><small class="req"> *</small>
                                                <textarea required name="method_bn"   id="method_bn" class="form-control {{ $errors->has('method_bn') ? ' is-invalid' : '' }}" placeholder="Course Method" cols="30" rows="10">{{$single->method_bn}}</textarea>
                                                @if ($errors->has('method_bn'))
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('method_bn') }}</strong>
                                                </span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-justify"><strong>Course Name:</strong> <span id="details_course_name_bn"></span> </p>
        ...
        $("#datatable").on("click",'.details',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $("#details_course_method_bn").text(data.course.method_bn);
